...
$modelSource = Join-Path $caseDir "input\model\dic_driven_10um.feb"
$positionsSource = Join-Path $caseDir "input\data\dic_positions.npy"
...
$runDir = Join-Path $repoRoot "out\validation\trabecular_meshwork_dic\$runId"
...
$env:VFM_DIC_POSITIONS = $positionsSource
$env:VFM_VALIDATION_METRICS = $metricsPath
$env:VFM_VALIDATION_SEED = "20260818"
