...
VFM-engine licensing is version-specific:
...
Third-party material is not relicensed by these files. See
`../docs/DEPENDENCY_LICENSE_AUDIT.md` and preserve every applicable third-party
notice.
